...
HD_PWD='/home/shmilybelon/Desktop/digital_logic/exp3_4/sd3_2/sd3_2.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log sd3_2.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source sd3_2.tcl
