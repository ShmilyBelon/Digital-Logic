...
HD_PWD='/home/shmilybelon/Desktop/digital_logic/exp3_4/sd3_2/sd3_2.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log sd3_2.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source sd3_2.tcl -notrace
